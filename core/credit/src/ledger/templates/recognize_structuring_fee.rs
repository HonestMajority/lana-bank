...
pub const RECOGNIZE_STRUCTURING_FEE_CODE: &str = "RECOGNIZE_STRUCTURING_FEE";

#[derive(Debug)]
pub struct RecognizeStructuringFeeParams {
...
impl RecognizeStructuringFeeParams {
...
impl From<RecognizeStructuringFeeParams> for Params {
    fn from(
        RecognizeStructuringFeeParams {
            journal_id,
            debit_account_id,
...
pub struct RecognizeStructuringFee;

impl RecognizeStructuringFee {
    #[instrument(name = "ledger.recognize_structuring_fee.init", skip_all)]
    pub async fn init(ledger: &CalaLedger) -> Result<(), CreditLedgerError> {
        let tx_input = NewTxTemplateTransaction::builder()
            .journal_id("params.journal_id")
            .effective("params.effective")
            .external_id("params.external_id")
            .description("'Recognize structuring fee'")
            .build()
        ...
        let entries = vec![
            NewTxTemplateEntry::builder()
                ...
                .entry_type("'RECOGNIZE_STRUCTURING_FEE_DR'")
                .direction("DEBIT")
                .layer("SETTLED")
                .build()
            ...
            NewTxTemplateEntry::builder()
                ...
                .units("params.structuring_fee_amount")
                .currency("params.currency")
                .entry_type("'RECOGNIZE_STRUCTURING_FEE_CR'")
                .direction("CREDIT")
                .layer("SETTLED")
                .build()
                .expect("Couldn't build entry"),
        ...
        let params = RecognizeStructuringFeeParams::defs();
        let template = NewTxTemplate::builder()
            .id(TxTemplateId::new())
            .code(RECOGNIZE_STRUCTURING_FEE_CODE)
