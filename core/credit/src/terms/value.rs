...
pub struct TermValues {
    ...
    #[builder(default)]
    pub disburse_full_amount_on_activation: bool,
}
...
impl TermValues {
    ...
    pub fn disburse_full_amount_on_activation(&self) -> bool {
        self.disburse_full_amount_on_activation
    }
...
mod test {
    ...
    #[test]
    fn disburse_full_amount_on_activation_toggle() {
        let terms = default_terms();
        assert!(!terms.disburse_full_amount_on_activation());
        ...
        let terms = TermValues::builder()
            ...
            .margin_call_cvl(dec!(125))
            .initial_cvl(dec!(140))
            .disburse_full_amount_on_activation(true)
            .build()
            .expect("should build a valid term");
